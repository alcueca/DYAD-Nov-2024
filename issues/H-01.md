# The V1 DYAD Supply is Counted in the Kerosine Price, but nor the V1 TVL
...
## Recommendation
Track the DYAD that has been minted for v2, and use that instead of the total supply.
